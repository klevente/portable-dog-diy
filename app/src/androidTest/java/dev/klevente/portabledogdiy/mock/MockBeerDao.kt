...
class MockBeerDao : BeerDao {
    ...
    private val beer1 = RoomBeer(
        ...
        targetFg = 1034,
        targetOg = 1070,
        volume = RoomVolume(25.0, "liters"),
        boilVolume = RoomVolume(25.0, "liters"),
        ...
        hops = listOf(RoomHop("Ahtanum", RoomMass(17.5, "grams"), "start"), RoomHop("Chinook", RoomMass(15.0, "grams"), "start")),
        yeast = "Wyeast 1056 - American Ale"
    )

    private val beer2 = RoomBeer(
        id = 2,
        name = "Test Beer 2",
        tagline = "Tagline 2",
